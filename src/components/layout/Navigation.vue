  ...
  <nav class="w-full h-full bg-gray-50 dark:bg-gray-800 p-12 
    ...
    <div class="flex items-center gap-4 mb-12">
      <button @click="toggleDarkMode" 
              class="w-12 h-12 bg-black dark:bg-white rounded-lg flex items-center justify-center 
      ...
      <button 
        ...
        <p class="text-gray-600 dark:text-gray-400 transition-colors duration-300 capitalize text-sm">
          Software Engineer
        </p>
      </button>
    </div>
    ...
    <div class="absolute bottom-12 left-12 right-12">
      <div class="flex gap-6 text-gray-600 dark:text-gray-400">
        <a href="https://github.com/LucvanDeenen" target="_blank" 
        ...
        <a href="https://www.linkedin.com/in/luc-van-deenen-561824194" target="_blank" 
           class="hover:text-black dark:hover:text-white transition-colors duration-200 flex items-center gap-2">
          <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
